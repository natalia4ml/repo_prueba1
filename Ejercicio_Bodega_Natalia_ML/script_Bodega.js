...
// -- AGREGAR CORRECCIONES Y REVISAR APUNTES DE OSMAR --

// -- MONTO A PAGAR POR CLIENTE --
salida.innerHTML = `<br> *** Clientes: ***`
salida.innerHTML += `<br>${cliente1.nombreCliente}: el monto a pagar por su pedido es: ${cliente1.montoPagarCliente()} '$' `
salida.innerHTML += `<br>${cliente2.nombreCliente}: el monto a pagar por su pedido es: ${cliente2.montoPagarCliente()} '$' `
salida.innerHTML += `<br>${cliente3.nombreCliente}: el monto a pagar por su pedido es: ${cliente3.montoPagarCliente()} '$' `
salida.innerHTML += `<br>${cliente4.nombreCliente}: el monto a pagar por su pedido es: ${cliente4.montoPagarCliente()} '$' `
salida.innerHTML += `<br>${cliente5.nombreCliente}: el monto a pagar por su pedido es: ${cliente5.montoPagarCliente()} '$' `
salida.innerHTML += '<br>'
...
/* VERS DE OSMAR CORREGIR Y PONER ESTA!
salida.innerHTML = `<br> *** Clientes: ***
<br>${cliente1.nombreCliente}: el monto a pagar por su pedido es: ${cliente1.montoPagarCliente()} '$' </br>
<br>${cliente3.nombreCliente}: el monto a pagar por su pedido es: ${cliente3.montoPagarCliente()} '$' </br>
<br>${cliente4.nombreCliente}: el monto a pagar por su pedido es: ${cliente4.montoPagarCliente()} '$' </br>
<br>${cliente5.nombreCliente}: el monto a pagar por su pedido es: ${cliente5.montoPagarCliente()} '$' </br>
</br>`
*/
